...
| FlakeHub | You want a stable Nix release | `nix profile install "https://flakehub.com/f/Jesssullivan/DarwinNicUtil/v2.1.3"` |
...
- Nix flake package outputs, including FlakeHub `v2.1.3`;
