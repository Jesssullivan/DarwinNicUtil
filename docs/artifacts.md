...
```bash
nix run "https://flakehub.com/f/Jesssullivan/DarwinNicUtil/v2.1.3" -- status
```
...
FlakeHub releases are `v2.1.3` and the rolling `*` channel.
...
publishing. The latest validated upload is `2.1.3`. The
[release workflow](https://github.com/Jesssullivan/DarwinNicUtil/actions/runs/34399959075)
and [FlakeHub publisher](https://github.com/Jesssullivan/DarwinNicUtil/actions/runs/34399959223)
completed on September 9, 2026. GitHub and PyPI publish matching wheel and source
distribution hashes. Install with:
...
install commands because the `v2.1.3` upload has been validated.
